...
parser = ArgumentParser(description='Explore DNA or RNA sequences')
parser.add_argument("-s", "--seq", type=str, required=True, help="Input a DNA or RNA sequence")
parser.add_argument("-m", "--motif", type = str, required = False, help = "Input the motif sequence that you are looking for")
